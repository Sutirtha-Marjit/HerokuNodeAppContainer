function AppBegin(){
    ...
    var customjobs = new CustomJobs();
     ...
     customjobs.appIndexFileModifier('LocationNoteBook');
     console.log('LocationNoteBook configured');
    
    app.use(express.static('ui'));    
    console.log('Static folder assigned');
    
    app.use('/SerisPhotoDownloader', express.static('apps/SerisPhotoDownloader/dist/'));
    app.use('/LocationNoteBook', express.static('apps/LocationNoteBook/dist/'));
